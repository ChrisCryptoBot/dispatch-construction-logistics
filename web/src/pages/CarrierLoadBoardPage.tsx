  ...
  const handleSubmitBid = async () => {
    ...
    try {
      ...
      alert(
        ...
        `📄 Rate Con will be sent to both you and your driver automatically!`
      )
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '16px' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ fontSize: '14px', color: theme.colors.textSecondary, margin: '0 0 4px 0' }}>
                      ...
                      {load.customer} • Posted {load.contractDate}
                    </p>
                    <p style={{ fontSize: '16px', fontWeight: '600', color: theme.colors.textPrimary, margin: 0 }}>
                      {load.commodity} • {load.units} {load.rateMode.replace('PER_', '').toLowerCase()}{load.units > 1 ? 's' : ''}
                    </p>
                  </div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
                  <div>
                    ...
                    <p style={{ fontSize: '14px', color: theme.colors.textPrimary, margin: 0 }}>
                      {selectedLoad.pickupCity} → {selectedLoad.deliveryCity} ({selectedLoad.mileage} mi)
                    </p>
                  </div>
                  <div>
