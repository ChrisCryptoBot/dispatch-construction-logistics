...
export const colors = {
  // Primary Brand Colors - Professional Muted Burgundy
  primary: {
    50: '#fef2f2',
    100: '#fee2e2',
    200: '#fecaca',
    300: '#fca5a5',
    400: '#f87171',
    500: '#9F1239', // Professional muted burgundy
    600: '#881337', // Darker professional burgundy
  ...
  status: {
    ...
    error: '#9F1239',      // Professional muted red (same as primary)
