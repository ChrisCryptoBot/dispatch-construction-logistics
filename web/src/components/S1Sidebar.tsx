    ...
    >
      ...
      >
        ...
        {isCollapsed && (
          ...
          onMouseEnter={(e) => {
            e.currentTarget.style.color = theme.colors.primary
            e.currentTarget.style.background = `linear-gradient(135deg, ${theme.colors.primary}20 0%, ${theme.colors.primary}10 100%)`
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.color = theme.colors.textPrimary
            e.currentTarget.style.background = `linear-gradient(135deg, ${theme.colors.primary}10 0%, ${theme.colors.primary}05 100%)`
          }}
          >
            S1
          </div>
